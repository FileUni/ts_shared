...
import type { LocaleMessageValue } from './bundle';
...
const converter = ConverterFactory(Locale.from.cn, Locale.to.twp, [TRADITIONAL_CHINESE_OVERRIDE_DICT]);
...
export function toTraditionalChineseDeep<T extends LocaleMessageValue | Record<string, unknown>>(value: T): T {
