import { DEFAULT_LOCALE, LOCALE_METADATA, type SupportedLocale } from './metadata';
...
const CANONICAL_LOCALE_BY_NORMALIZED = Object.fromEntries(
  (Object.keys(LOCALE_METADATA) as SupportedLocale[]).map((locale) => [normalizeRawLocale(locale), locale]),
