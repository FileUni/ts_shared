import { DEFAULT_LOCALE, type SupportedLocale } from '../localization/metadata';
...
export function parseBrowserThemePreference(value: string | null | undefined): BrowserThemePreference | null {
